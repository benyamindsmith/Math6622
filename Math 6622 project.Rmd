...
The sinking of the Titanic is one of the most infamous shipwrecks in history.
  ...
  In this report we will explore the data set on the passengers of the Titanic and determine what are the key factors for predicting passenger survival. After this we will proceed with showing a developed model and go through the required diagnostics 
